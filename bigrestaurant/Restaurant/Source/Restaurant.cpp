...
bool Restaurant::addEmployee(EmployeeType Typ)
{
    ...
    {
    case MANAGER:
        newAccount = new Manager(id, name, account, email, phone);
        break;
    case WAITER:
        newAccount = new Waiter(id, name, account, email, phone);
        break;
    case CHEF:
        newAccount = new Chef(id, name, account, email, phone);
        break;
    case RECEPTIONIST:
        newAccount = new Receptionist(id, name, account, email, phone);
        break;
    }
